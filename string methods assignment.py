...
print(txt.format(fname = "Kim", age = 56))
...
txt21 = txt20.rstrip()
print("Vengaboys on call",txt21, "be guided")
...
txt15 = txt14.strip()
print("We're gonna have a party", txt15,"We are now approaching Ibiza airport" )
